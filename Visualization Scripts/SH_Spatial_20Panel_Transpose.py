...
### Color map and range
cmap = plt.cm.jet
cLevels = [0,25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400,425,450,475,500,525,550,575,600,625,650] #np.arange(0,13,.2)
...
###Get Variables
#Dec 2017
dec17_ctl_lh= dec17_ctl['shtfl'][0]
dec17_sta_lh= dec17_sta['shtfl'][0]
dec17_dyn_lh= dec17_dyn['shtfl'][0]

#Feb 2021
feb21_ctl_lh= feb21_ctl.select(name='Sensible heat net flux', typeOfLevel='surface', forecastTime=33)[0].values
feb21_sta_lh= feb21_sta.select(name='Sensible heat net flux', typeOfLevel='surface', forecastTime=33)[0].values
feb21_dyn_lh= feb21_dyn.select(name='Sensible heat net flux', typeOfLevel='surface', forecastTime=33)[0].values

#Jan 2022
jan22_ctl_lh= jan22_ctl['shtfl'][0]
jan22_sta_lh= jan22_sta['shtfl'][0]
jan22_dyn_lh= jan22_dyn['shtfl'][0]

#Nov 2022
nov22_ctl_lh= nov22_ctl['shtfl'][0]
nov22_sta_lh= nov22_sta['shtfl'][0]
nov22_dyn_lh= nov22_dyn['shtfl'][0]
...
#fig.tight_layout()
plt.savefig(base_fp +'Publication/Figures/SH_Spatial_Comparison_20panels_Transpose.png', dpi=1800)
